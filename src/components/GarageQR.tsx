      ...
      {showQR && (
        <div style={{
          ...
          <div className="glass" style={{ position: 'relative', padding: '32px', textAlign: 'center', maxWidth: '380px', width: '100%' }}>
            <button onClick={() => setShowQR(false)} style={{ position: 'absolute', top: '12px', right: '16px', background: 'none', border: 'none', color: '#2c3e50', fontSize: '20px', cursor: 'pointer' }}>&times;</button>
